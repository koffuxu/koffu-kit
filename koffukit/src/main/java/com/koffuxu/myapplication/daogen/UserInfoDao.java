...
public class UserInfoDao extends AbstractDao<UserInfo, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FatherId = new Property(5, Long.class, "fatherId", false, "FATHER_ID");
    };
    ...
    public UserInfo readEntity(Cursor cursor, int offset) {
        UserInfo entity = new UserInfo( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // hobby
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // gender
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4), // id
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5) // fatherId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, UserInfo entity, int offset) {
        ...
        entity.setHobby(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        ...
        entity.setFatherId(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getFatherUserInfoDao().getAllColumns());
            builder.append(" FROM USER_INFO T");
            builder.append(" LEFT JOIN FATHER_USER_INFO T0 ON T.\"FATHER_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected UserInfo loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        FatherUserInfo fatherUserInfo = loadCurrentOther(daoSession.getFatherUserInfoDao(), cursor, offset);
        entity.setFatherUserInfo(fatherUserInfo);
